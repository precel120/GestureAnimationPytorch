...
\section{Wyniki i dyskusja}
{
  ...
  \subsection{Pix2Pix}
  {
    ...
    Nie można jednoznacznie stwierdzić z czego to wynika. 
    Może to być spowodowane kwestią zarządzania pamięci, biblioteka OpenCV, która wczytuje obrazy, nie inicjuje się na nowo przy każdej klatce i na nowo jest wykorzystywana. 
    Przy generowaniu jednej klatki, zasób może już zostać zwolniony. 
    Niezależnie od różnicy czasów wygenerowania 1 czy 30 obrazów, sieć osiągneła bardzo dobry wynik. 
    Tu duży wpływ może mieć sprzęt, ale jak również odpowiednio dobrany model, który nie wykonuje dużej ilości obliczeń, a otrzymane efekty są bardzo dobre. 
