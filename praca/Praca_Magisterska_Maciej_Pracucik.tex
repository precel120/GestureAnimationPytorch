...
\section{Wyniki i dyskusja}
{
  ...
  \subsection{Pix2Pix}
  {
    ...
    \begin{figure}[H]
      ...
      \end{subfigure}
      \caption{Odpowiednio: epoka 1, 20, 40, 50. Parametry: batch - 256, epochs - 50, learning rate - 1e-4, lambda - 100}
    \end{figure}
    ...
    \begin{figure}[H]
      ...
      \end{subfigure}
      \caption{Odpowiednio: epoka 1, 20, 40, 60, 80, 100. Parametry: batch - 256, epochs - 100, learning rate - 1e-4, lambda - 10}
    \end{figure}
    \begin{figure}[H]
      \begin{subfigure}{.5\textwidth}
        \centering
      ...
      \end{subfigure}
      \caption{Odpowiednio: epoka 1, 20, 40, 60, 80, 100. Parametry: batch - 256, epochs - 100, learning rate - 1e-4, lambda - 15}
    \end{figure}
    \begin{figure}[H]
      \begin{subfigure}{.5\textwidth}
        \centering
      ...
      \begin{subfigure}{.5\textwidth}
        ...
        \includegraphics[width=.8\linewidth]{pix2pix/output_copy_6/generated_100.jpg}
      \end{subfigure}
      \caption{Odpowiednio: epoka 1, 20, 40, 60, 80, 100. Parametry: batch - 256, epochs - 200, learning rate - 1e-4, lambda - 20}
    \end{figure}
...
\section{Podsumowanie}
{
  ...
  Jak zostało wspomniane, efekt jest zadowlający, lecz nie idealny. 
  Najlepiej można to zaobserwować na samej animacji, gdzie klatki pośrednie są mało wyraźne. 
  Podobnie obszar, gdzie znajdowała się maska dłoni, jest mało wyraźny. 
