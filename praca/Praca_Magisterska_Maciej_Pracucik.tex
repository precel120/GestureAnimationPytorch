...
\section{Podsumowanie}
{
  ...
  \begin{figure}[H]
    ...
    \label{anim}
  \end{figure}
  Na Rysunku \ref{anim} można zauważyć, że gest startowy jak i końcowy są zdecydowanie najlepsze. 
  Wynika to z faktu, że to właśnie na tych dwóch gestach uczyła się sieć, a wszystkie inne wariacje ustawień szkieletu stanowią większy problem. 
